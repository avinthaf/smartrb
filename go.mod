...
replace smartrb.com/api => ./api

replace smartrb.com/auth => ./auth

replace smartrb.com/mq => ./mq

replace smartrb.com/db => ./db
...
require (
	...
	smartrb.com/auth v0.0.0-00010101000000-000000000000 // indirect
)

replace smartrb.com/users => ./users

replace smartrb.com/categories => ./categories
